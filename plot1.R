...
img.w <- 480
img.bg <- "white"
img.plot.main <- "Global Active Power"
img.plot.xlab <- "Global Active Power (kilowatts)"
img.plot.col <- "red"
...
hist(df.selected$Global_active_power, col = img.plot.col, main = img.plot.main, xlab = img.plot.xlab)
dev.off()
